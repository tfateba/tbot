 ...
 * @return    msg   The result of the reading identity operation.
 */
 ...
 * @return    msg   The result of the power mode configuration.
 */
 ...
 *
 * @param[in] i2cp  The pointer of the i2C interface.
 * @return    msg   The result of the wakeup operation.
 */
 ...
 *
 * @param[in] i2cp  The pointer of the i2C interface.
 * @param[in] scale The scale to set the MPU6050(250, 500, 1000 or 2000).
 * @return    msg   The result of the wakeup operation.
 */
 ...
 *
 * @param[in] i2cp  The pointer of the i2C interface.
 * @param[in] scale The scale to set the MPU6050(2, 4, 8 or 16).
 * @return    msg   The result of the wakeup operation.
 */
 ...
 * @return    msg   The result of the offset reading operation.
 */
 ...
 * @return    msg     The result of the offset writing operation.
 */
...
/**
 * @fn    msg_t mpu6050_getZGyroOffset(I2CDriver *i2cp, int16_t *gzop)
...
/**
 * @fn    msg_t mpu6050_setZGyroOffset(I2CDriver *i2cp, int16_t offset)
...
/**
 * @fn    msg_t mpu6050_setZAccelOffset(I2CDriver *i2cp, uint16_t offset)
...
/**
 * @fn    msg_t mpu6050_read(I2CDriver *i2cp, uint8_t *pmp)
 * @brief Configure the accelerometer full scale.
 *
 * @param[in] i2cp  The pointer of the i2C interface.
 * @param[in] pmp   The pointer to the power management configuration.
 * @return    msg   The result of the reading  operation.
 */
...
/**
 * @fn    msg_t mpu6050_readAllSensors(I2CDriver *i2cp, uint8_t *rxbuf)
 * @brief Read all axis of data and also the temperature.
 *
 * @param[in] i2cp  The Pointer of the i2C interface.
 * @param[in] rxbuf The reception buffer for the i2c data readed.
 * @return    msg   The result of the reading operation.
 */
...
/**
 * @fn    msg_t mpu6050_getData(I2CDriver *i2cp, mpu6050_t *mpup)
 * @brief Read data from the IMU sensors.
 *
 * @param[in] i2cp  The pointer of the i2C interface.
 * @param[in] mpup  The pointer of the mpu6050 data structure.
 * @return    msg   The result of the reading operation.
 */
...
/**
 * @fn    msg_t mpu6050_calibration(I2CDriver *i2cp, mpu6050_t *mpup)
 * @brief Calibrate the MPU6050 accelerometer and gyroscope sensors.
 *
 * @param[in] i2cp  The pointer of the i2C interface.
 * @param[in] mpup  The pointer of the mpu data structure.
 * @return    msg   The result of the calibration operation.
 */
...
/**
 * @fn    msg_t mpu6050_init(I2CDriver *i2cp, mpu6050_t *mpu,
 *                  mpu6050_sad_e sad){
 * @brief Initialize the MPU6050 sensor.
 *
 * @param[in] i2cp  The Pointer of the i2C interface.
 * @param[in] sad   The MPU i2c serial address.
 * @return    msg   The result of the initialization operation.
 */
